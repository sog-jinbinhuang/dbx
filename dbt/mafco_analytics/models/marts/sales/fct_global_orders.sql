with base_data as (
    ...
    where upper(order_trl.order_status) in ('OPEN', 'PARTIALLY SHIPPED')
...
step_02 as (
    select
        ...
        case
            when b.qty_um is null or upper(b.qty_um) in ('E', '')
...
select
    ...
    o.order_num,
    o.year_period,
    to_date(o.ship_date)            as ship_date,
    to_date(o.order_date)           as order_date,
    cast(o.delivery_date as string) as delivery_date,
    o.default_ship_from_warehouse,
    o.cust_division,
    o.country_name,
    o.cust_name,
    o.customer_po_num,
    ...
    o.qty_um,
    o.order_open_amount,
    cast(null as double)            as invoice_currency_conversion_rate,
    o.order_currency,
    cast(null as double)            as cogs_currency_conversion_rate,
    o.order_date                    as orderdate,
    cast(null as string)            as journal_number,
    cast(null as string)            as cogs_journal_number,
    o.pkg_um,
    o.pkg_measure,
    o.group_id,
    cast(null as string)            as ref_type,
    cast(null as string)            as return_warehouse,
    cast(null as string)            as cm_dm_type,
    o.territory,
    o.industry_code,
    o.active_customer,
    o.sa_id,
    o.sales_agent,
    o.sales_agent2                  as sales_rep,
    o.customer_class                as region,
    o.open_qty_in_kg,
    o.usd_sales_x_rate,
    o.price_per_kg,
    o.cost_per_kg,
    o.price_per_kg_local_currency,
    o.cost_per_kg_local_currency,
    o.profit_per_kg_local_currency,
    o.ext_price_local_currency,
    o.ext_cost_local_currency,
    o.ext_profit_local_currency,
    o.price_per_kg_in_usd,
    o.cost_per_kg_in_usd,
    o.profit_per_kg_in_usd,
    o.ext_price_in_usd              as revenue,
    o.ext_cost_in_usd               as cogs,
    o.ext_profit_in_usd             as profit,
    trim(o.year)                    as year,
    cast(
        case when length(o.month) = 1 then concat('0', o.month) else o.month end
        as int
    )                               as month,
    o.qty_in_drykg,
    o.database,
    ...
    o.cust_product_n,
    o.segment,
    o.region_segment_group_product_n,
    o.region_segment_cust_product_n,
    o.region_segment,
    o.region_segment_group
